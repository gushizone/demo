...
public class FlowableTestV5_3 {
    ...
    public static final String PROCESS_DEFINITION_KEY = "holiday-v5_3";
    ...
    public void tasks() {
        ...
        List<String> assignees = Lists.newArrayList( "u1", "u2", "u3", "u4", "m1");
...
//        processVariables.put("num", 4);
    ...
    @Test
    @Order(5)
    public void completeTaskM1() {

        List<Task> tasks = taskService.createTaskQuery()
                .taskAssignee("m1")                 // 任务处理人
                .processDefinitionKey(PROCESS_DEFINITION_KEY)   // 流程类型
                .list();
